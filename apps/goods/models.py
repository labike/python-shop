...
class GoodsCategory(models.Model):
    ...
    parent_category = models.ForeignKey('self', null=True, blank=True, verbose_name='父类级别', related_name='sub_cat')
...
class Goods(models.Model):
    ...
    shop_price = models.FloatField(default=0, verbose_name='商品本店价格')
    goods_brief = models.TextField(max_length=500, verbose_name='商品简短描述')
    goods_desc = UEditorField(default='', verbose_name='内容', imagePath='goods/images/', width=1000, height=300,
                              filePath='goods/files/')
    ship_free = models.BooleanField(default=True, verbose_name='是否承担运费')
    goods_front_image = models.ImageField(upload_to='goods/images/', null=True, blank=True, verbose_name='封面图')
    is_new = models.BooleanField(default=False, verbose_name='是否是新品')
    is_hot = models.BooleanField(default=False, verbose_name='是否是热销')
